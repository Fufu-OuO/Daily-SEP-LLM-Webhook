...
def call_deepseek(entry):
    ...
    prompt = f"""
    你是一位哲学科普作者。请阅读斯坦福哲学百科的条目 '{entry['title']}' ({entry['link']})，并用中文生成一篇 1000 字内的核心摘要；如果遇到人名或书名，请呈现“原文（翻译）”，譬如：Immanuel Kant（伊曼努尔·康德）、The Critique of Pure Reason（《纯粹理性批判》）。结构分四段：
    1. 一句话点出这个理论的核心命题或争议。
